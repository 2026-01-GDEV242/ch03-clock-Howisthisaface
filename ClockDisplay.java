 ...
 * range of the clock is 12:00am (midnight) to 11.59 AM (one minute before noon
 * and 12:00 pm (noon) to 11:59 (one minute before 
 * midnight).
 * 
 * the numberDesplay stores values from 0-11. When the hours number display is zero, the
 ...
 * the time should be read as 12:00 AM
 * 
